...
* **V6.1.1:** Document the application's authentication, session management, and access control design.
...
* [ ] **Passwords / Passphrases:**
    * *If checked, the password policy defined in the V2 Authentication decision template must be followed.*
...
* **Session Token Type:** `(e.g., Stateful session identifiers stored server-side, Stateless JWTs)`
